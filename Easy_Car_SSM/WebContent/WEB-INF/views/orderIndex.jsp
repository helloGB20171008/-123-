...
<c:forEach items="${requestScope.orderlist}" var="order" varStatus="a">
<tr>
 
<td><a href="<%=request.getContextPath()%>/order/turnorderSelectById?orderId=${order.getOrderId()}">${order.getOrderId()}</a>
</td>
